/*
  08-05-2018   1.0.1 Cleaned up some code, added more topics, renamed folder
...
bool pwm1Handler(HomieRange range, String value) {
  ...
  motor1Node.setProperty("pwm").send(value);
  return true;
}
...
bool pwm2Handler(HomieRange range, String value) {
  ...
  motor2Node.setProperty("pwm").send(value);
  return true;
}
...
bool motor1Handler(HomieRange range, String value) {
  ...
  M1.setmotor( directionMotor1, pwmMotor1);
  motor1Node.setProperty("direction").send(value);
  return true;
}
...
bool motor2Handler(HomieRange range, String value) {
  ...
  motor2Node.setProperty("direction").send(value);
  return true;
}
